...
sub_driver:
    ...
    .backwave:
        ...
        cmp     byte[add_res+MAXL-1], 0
        jge     .done;减法完成
        mov     byte[add_res], N;没跳转的都是负号
        mov     edx, MAXL-1
    ;现在，我们要把高位的-1往低位推
    .negative_proc:
        cmp     edx, 1;for(i=MAXL-1;i>1;i--)
        je      .first_proc        
